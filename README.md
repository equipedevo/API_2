...
| 02     | 15/10/2023 | :construction: Em progresso | --        |
...
| 009 | 2      | Cliente         | que todos os usuários do meu sistema possam alterar seus dados pessoais.                               | :white_circle: Baixa      | Acesso ao perfil pessoal, com ferramenta para edição de informações, com conexão ao banco de dados                                                               |
...
| 011 | 3      | Cliente-empresa | que todos os chamados sejam armazenados permanentemente                                     | :white_circle: Baixa      |Criar banco de dados para armazenar infosmações dos chamados             |
| 012 | 4      | Administrador   |  ter acesso a relatórios analíticos do sistema, para poder acompanhar a eficácia do mesmo.                           | :white_circle: Baixa      | Página com relátorios  analíticos                                                                              |
