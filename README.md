...
| 008 | 2      | Cliente-empresa   |  que meus usuários possam abrir chamados                 | :large_orange_diamond: Média      | Página para a abertura dos chamados de serviço                                                                            |
| 008 | 2      | Administrador   |  poder cadastrar técnicos e usuários comuns, para que possam abrir chamados                 | :large_orange_diamond: Média      | Acesso ao usuário "Administrador" com opções para cadastrar usuários                                                                           |
