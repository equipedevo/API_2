...
| 009 | 2      | Administrador   |  poder cadastrar técnicos e usuários comuns, para que possam abrir chamados                 | :large_orange_diamond: Média      | Acesso ao usuário "Administrador" com opções para cadastrar usuários                                                                           |
...
| 011 | 3     | Cliente         | que os chamados tenham prioridade de resolução e graus de urgência                               | :red_circle: Alta      | Sistema delegar automaticamente a prioridade                                                               |
| 012 | 3      | Administrador | que todos os chamados sejam armazenados permanentemente                                     | :red_circle: Alta      |Criar banco de dados para armazenar infosmações dos chamados             |
...
| 014 | 4     | Cliente         | que todos os usuários do meu sistema possam alterar seus dados pessoais.                               | :white_circle: Baixa      | Acesso ao perfil pessoal, com ferramenta para edição de informações, com conexão ao banco de dados                                                               |
