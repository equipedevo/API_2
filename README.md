...
| 010 | 3      | Administrador | que todos os chamados sejam armazenados permanentemente                                     | :red_circle: Alta      |Criar banco de dados para armazenar infosmações dos chamados             |
| 011 | 4      | Cliente | que os chamados tenham sua resolução pré-estimada                                    | :red_circle: Alta      | Sistema que delegue automaticamente a estimativa de resolução dos chamados             |
| 012 | 4     | Cliente         | que todos os usuários do meu sistema possam alterar seus dados pessoais.                               | :white_circle: Baixa      | Acesso ao perfil pessoal, com ferramenta para edição de informações, com conexão ao banco de dados                                                               |
| 013 | 4      | Administrador   |  ter acesso a relatórios analíticos do sistema, para poder acompanhar a eficácia do mesmo.                           | :white_circle: Baixa      | Página com relátorios  analíticos                                                                              |
| 014 | 4      | Cliente         |  que qualquer usuário possa saber como usar o sistema,  que o sistema fique eficiente.                               | :large_orange_diamond: Média      | Botão de ajuda com manual online para usuários                                                                 |
